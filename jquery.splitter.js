(function(factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define('splitter', ['jquery'], factory);
    } else if (typeof exports === 'object') {
        // Node/CommonJS
        module.exports = factory(require('jquery'));
    } else if (jQuery && !jQuery.fn.splitter) {
    ...
    function SplitterManager() {
        var splitters = [], current = null, drag = false, bgColor = null, current = null, dragObj = null;
    ...
    function Splitter(parent, div1, div2, horizontal) {
        ...
        manager.add(this);
        var self = this, keepLeft = true, limit = 0, paneResized = null, windowResized = null, parent = $(parent), div1 = $(div1), div2 = $(div2), resizebar = $("<div class='splitter-resizebar'></div>").appendTo(parent);
